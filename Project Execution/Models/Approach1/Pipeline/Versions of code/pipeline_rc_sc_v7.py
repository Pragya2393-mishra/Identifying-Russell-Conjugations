...
data1[data1.y ==1].count() #286
data1[data1.y ==0].count() #3568
...
test1 = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Test files for try17/test18.csv')
...
result1=result
result.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_pipeline_rc_sc_v7.csv')

result_dataframe = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Results/SC/Results_pipeline_rc_sc_v7_formatted.csv')

confusion_matrix(result_dataframe['y'],result_dataframe['ypred_mcreated'])
#array([[447,   0],
#       [ 10,  71]], dtype=int64)

accuracy= accuracy_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9810606060606061
f1=f1_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9342105263157895
precision= precision_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #1.0
recall=recall_score(result_dataframe['y'],result_dataframe['ypred_mcreated'])#0.8765432098765432