...
accuracy= accuracy_score(test1['y'],test1['ypred']) #0.5098039215686274
f1=f1_score(test1['y'],test1['ypred']) #0.6666666666666666
precision= precision_score(test1['y'],test1['ypred']) #0.7142857142857143
recall=recall_score(test1['y'],test1['ypred'])#0.625
...
accuracy= accuracy_score(result2['y'],result2['ypred2']) #0.6078431372549019
f1=f1_score(result2['y'],result2['ypred2']) #0.6666666666666666
precision= precision_score(result2['y'],result2['ypred2']) #1.0
recall=recall_score(result2['y'],result2['ypred2'])#0.5

result2.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Pipeline/final versions/trying_rc_data19v3_test18_data27v3.csv')
