...
pragya=X_test['res_vector']
pragya=pragya.reset_index(drop=True)
pragya=list(pragya)
for i in range(len(pragya)):
    if (pragya[i].shape[0]!=300):
        print(i)

y_pred = clf.predict(pragya)
accuracy_score(X_test['y'],y_pred) #0.7692307692307693
