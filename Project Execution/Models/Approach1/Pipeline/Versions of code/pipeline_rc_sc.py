...
result.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_pipeline_rc_sc.csv')

result_dataframe = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Results/SC/Results_pipeline_rc_sc_formatted.csv')

confusion_matrix(result_dataframe['y'],result_dataframe['ypred_mcreated'])
#array([[22,  1],
#       [ 5, 12]], dtype=int64)

accuracy= accuracy_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.85
f1=f1_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.8000000000000002
precision= precision_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9230769230769231
recall=recall_score(result_dataframe['y'],result_dataframe['ypred_mcreated'])#0.7058823529411765
