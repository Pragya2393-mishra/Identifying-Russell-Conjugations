...
result.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_pipeline_rc_sc_v8.csv')

result_dataframe = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Results/SC/Results_pipeline_rc_sc_v8_formatted.csv')

confusion_matrix(result_dataframe['y'],result_dataframe['ypred_mcreated'])
#array([[11,  0],
#       [ 7, 35]], dtype=int64)

accuracy= accuracy_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.8679245283018868
f1=f1_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9090909090909091
precision= precision_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #1.0
recall=recall_score(result_dataframe['y'],result_dataframe['ypred_mcreated'])#0.8333333333333334
