...
result.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_pipeline_rc_sc_v3.csv')
result_dataframe = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Results/SC/Results_pipeline_rc_sc_v3_formatted.csv')

confusion_matrix(result_dataframe['y'],result_dataframe['ypred_mcreated'])
#array([[448,   0],
#       [  5,  67]], dtype=int64)

accuracy= accuracy_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9903846153846154
f1=f1_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9640287769784173
precision= precision_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #1.0
recall=recall_score(result_dataframe['y'],result_dataframe['ypred_mcreated'])#0.9305555555555556