...
result.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_pipeline_rc_sc_v4.csv')

result_dataframe = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Results/SC/Results_pipeline_rc_sc_v4_formatted.csv')

confusion_matrix(result_dataframe['y'],result_dataframe['ypred_mcreated'])
#array([[11,  0],
#       [ 5, 28]], dtype=int64)

accuracy= accuracy_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.8863636363636364
f1=f1_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #0.9180327868852458
precision= precision_score(result_dataframe['y'],result_dataframe['ypred_mcreated']) #1.0
recall=recall_score(result_dataframe['y'],result_dataframe['ypred_mcreated'])#0.8484848484848485
