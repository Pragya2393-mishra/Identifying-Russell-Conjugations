...
accuracy= accuracy_score(X_test['y'],y_pred) #0.5252416756176155
f1=f1_score(X_test['y'],y_pred) #0.09053497942386832
precision= precision_score(X_test['y'],y_pred) #0.05583756345177665
recall=recall_score(X_test['y'],y_pred) # 0.2391304347826087
...
y_pred=clf.predict(a)
accuracy= accuracy_score(test1['y'],y_pred) #0.46938775510204084
f1=f1_score(test1['y'],y_pred) #0.23529411764705882
precision= precision_score(test1['y'],y_pred) #0.25
recall=recall_score(test1['y'],y_pred) #0.2222222222222222
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/try18_dataversion13_test5_logistic_result.csv')
