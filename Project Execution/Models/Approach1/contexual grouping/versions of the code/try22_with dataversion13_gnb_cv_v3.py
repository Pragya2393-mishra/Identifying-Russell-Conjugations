...
data = pd.read_csv('F:/somebody gonna get hurt/Github/Model/data/datav16.csv')
...
test1 = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Test files for try17/test7.csv')
l =[]
...
accuracy= accuracy_score(test1['y'],y_pred) #0.9411764705882353
...
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_Test7_data16.csv')