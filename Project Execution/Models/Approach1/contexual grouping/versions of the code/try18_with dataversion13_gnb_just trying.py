...
#precision= np.mean(precision) #0.8742013584061269
#recall= np.mean(recall) #0.8696814331677208
#accuracy=np.mean(accuracy) #0.8696814331677208
#f1=np.mean(f1) #0.8692809420905967
