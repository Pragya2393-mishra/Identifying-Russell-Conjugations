...
accuracy= accuracy_score(X_test['y'],y_pred) #0.6214750542299349
f1=f1_score(X_test['y'],y_pred) #0.1382716049382716
precision= precision_score(X_test['y'],y_pred) #0.0880503144654088
recall=recall_score(X_test['y'],y_pred) #0.3218390804597701
...
y_pred=clf.predict(a)
accuracy= accuracy_score(test1['y'],y_pred) #0.3877551020408163
f1=f1_score(test1['y'],y_pred) #0.11764705882352941
precision= precision_score(test1['y'],y_pred) #0.125
recall=recall_score(test1['y'],y_pred) #0.1111111111111111
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/try18_dataversion13_test5_svm_result.csv')
