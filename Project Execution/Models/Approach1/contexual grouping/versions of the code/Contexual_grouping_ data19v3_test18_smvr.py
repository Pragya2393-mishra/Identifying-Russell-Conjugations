...
test1['y-pred']=y_pred
accuracy= accuracy_score(test1['y'],test1['y-pred']) #0.5098039215686274
f1=f1_score(test1['y'],test1['y-pred']) #0.6666666666666666
precision= precision_score(test1['y'],test1['y-pred']) #0.7142857142857143
recall=recall_score(test1['y'],test1['y-pred']) #0.625
...
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Models/Russell Conjugation grouping/Final version/Contexual_grouping_Test18_data19v3_svmr.csv')