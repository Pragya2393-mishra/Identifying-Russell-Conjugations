...
data = pd.read_csv('F:/somebody gonna get hurt/Github/Model/negative samples_without not in dict and res.csv')
data_del=data[data.x1==data.x2]
new_data=data[data.x1!=data.x2]
...
data1 = data[data.res_vector != 'not in dictionary']
...
new_data.to_csv('F:/somebody gonna get hurt/Github/Model/negative_samples_final.csv')
