...
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svml_cv/f1.csv", f1, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svml_cv/accuracy.csv", accuracy, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svml_cv/precision.csv", precision, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svml_cv/recall.csv", recall, delimiter=",")
