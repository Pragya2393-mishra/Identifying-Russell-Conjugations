...
X=data
X_train, X_test= train_test_split( X, test_size=0.2, random_state=500)
...
accuracy_score(X_test['y'],y_pred) #0.8266666666666667
precision_score(X_test['y'],y_pred) #0.9117647058823529
recall_score(X_test['y'],y_pred) #0.7560975609756098
f1_score(X_test['y'],y_pred) #0.8266666666666665
