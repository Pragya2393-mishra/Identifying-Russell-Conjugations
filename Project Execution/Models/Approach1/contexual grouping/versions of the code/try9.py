...
test_data = pd.read_csv('F:/somebody gonna get hurt/Github/Literature survey/Collecting Russell Conjugations/Data/test_random1.csv')
...
accuracy_score(test_data['y'],y_pred) #0.6363636363636364
precision_score(test_data['y'],y_pred) #0.0
recall_score(test_data['y'],y_pred) #0.0
f1_score(test_data['y'],y_pred) #0.0
