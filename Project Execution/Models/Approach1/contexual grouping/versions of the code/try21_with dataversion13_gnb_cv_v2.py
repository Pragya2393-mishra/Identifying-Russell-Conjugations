...
test1 = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Test files for try17/test6.csv')
l =[]
...
accuracy= accuracy_score(test1['y'],y_pred) #0.7777777777777778
f1=f1_score(test1['y'],y_pred) #0.7586206896551724
precision= precision_score(test1['y'],y_pred) #0.8461538461538461
recall=recall_score(test1['y'],y_pred) #0.6875
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results.csv')