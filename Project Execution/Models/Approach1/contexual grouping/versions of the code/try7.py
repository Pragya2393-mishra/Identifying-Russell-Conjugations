...
X=data
X_train, X_test= train_test_split( X, test_size=0.6, random_state=500)
...
accuracy_score(X_test['y'],y_pred) #0.759090909090909
precision_score(X_test['y'],y_pred) #0.7413793103448276
recall_score(X_test['y'],y_pred) #0.7889908256880734
f1_score(X_test['y'],y_pred) #0.7644444444444446
