...
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svmr_cv/f1.csv", f1, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svmr_cv/accuracy.csv", accuracy, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svmr_cv/precision.csv", precision, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_svmr_cv/recall.csv", recall, delimiter=",")

f1=np.mean(f1) #0.3619258121317979
accuracy = np.mean(accuracy) #0.5591698911204788
precision = np.mean(precision) #0.4448754231087845
recall= np.mean(recall) #0.3428455618381271
