...
data = pd.read_csv('F:/somebody gonna get hurt/Github/Model/data/datav19_v3.csv')
...
accuracy= accuracy_score(test1['y'],y_pred) #0.775
f1=f1_score(test1['y'],y_pred) #0.7804878048780487
precision= precision_score(test1['y'],y_pred) #0.6666666666666666
recall=recall_score(test1['y'],y_pred) #0.9411764705882353
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Models/Sentiment classification/Final version/Contexual_grouping_Test18_data19v3_svmr.csv')