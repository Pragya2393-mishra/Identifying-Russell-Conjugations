...
accuracy_score(test_data['y'],y_pred) #0.6470588235294118
precision_score(test_data['y'],y_pred) #0.42857142857142855
recall_score(test_data['y'],y_pred) #0.6
f1_score(test_data['y'],y_pred) #0.5
