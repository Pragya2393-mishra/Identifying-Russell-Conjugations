...
X=data
X_train, X_test= train_test_split( X, test_size=0.5, random_state=500)
...
accuracy_score(X_test['y'],y_pred) #0.8
precision_score(X_test['y'],y_pred) #0.7931034482758621
recall_score(X_test['y'],y_pred) #0.7840909090909091
f1_score(X_test['y'],y_pred) #0.7885714285714285
