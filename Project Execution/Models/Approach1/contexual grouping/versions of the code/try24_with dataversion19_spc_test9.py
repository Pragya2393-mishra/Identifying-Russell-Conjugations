...
f1=np.mean(f1) #0.8010126950826674
accuracy = np.mean(accuracy) #0.9395780864383859
precision = np.mean(precision) #0.9193149758410575
recall= np.mean(recall) #0.7544005647482449
...
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_Test9_data19_svmr.csv')