...
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_logistic_cv/f1.csv", f1, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_logistic_cv/accuracy.csv", accuracy, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_logistic_cv/precision.csv", precision, delimiter=",")
np.savetxt("F:/somebody gonna get hurt/Github/Model/Results/Try21_logistic_cv/recall.csv", recall, delimiter=",")

f1=np.mean(f1) #0.32644447431276347
accuracy = np.mean(accuracy) #0.4738810289926336
precision = np.mean(precision) #0.4324275290420072
recall= np.mean(recall) #0.2758799963274495
