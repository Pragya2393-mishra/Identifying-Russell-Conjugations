...
X=data
X_train, X_test= train_test_split( X, test_size=0.3, random_state=500)
...
accuracy_score(X_test['y'],y_pred) #0.8053097345132744
precision_score(X_test['y'],y_pred) #0.7959183673469388
recall_score(X_test['y'],y_pred) #0.7647058823529411
f1_score(X_test['y'],y_pred) #0.7799999999999999
