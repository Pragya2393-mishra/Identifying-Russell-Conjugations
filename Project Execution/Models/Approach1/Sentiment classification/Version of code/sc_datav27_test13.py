...
test1 = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Test files for try17/test13.csv')
l =[]
...
#       [ 1, 10,  0],
#       [ 0,  1, 10]], dtype=int64)
accuracy= accuracy_score(test1['y'],y_pred) #0.90625

test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_Test13_data27_sc_v2.csv')
