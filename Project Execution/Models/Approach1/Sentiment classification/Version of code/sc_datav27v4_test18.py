...
#array([[ 9,  2],
#       [ 8, 32]], dtype=int64)
accuracy= accuracy_score(test1['y'],test1['y-pred']) #0.803921568627451
f1=f1_score(test1['y'],test1['y-pred']) #0.8648648648648648
precision= precision_score(test1['y'],test1['y-pred']) #0.9411764705882353
recall=recall_score(test1['y'],test1['y-pred'])#0.8

test1.to_csv('F:/somebody gonna get hurt/Github/Model/Models/Sentiment classification/Final version/SC_Test18_data27v4.csv')
