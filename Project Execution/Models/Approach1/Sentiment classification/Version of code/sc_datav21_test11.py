...
data = pd.read_csv('F:/somebody gonna get hurt/Github/Model/data/datav21.csv')
...
test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_Test11_data21_sc_v2.csv')

model.most_similar('persisent')