...
test1 = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Test files for try17/test14.csv')
l =[]
...
#       [ 1, 10,  0],
#       [ 4,  1, 34]], dtype=int64)
accuracy= accuracy_score(test1['y'],y_pred) #0.9066666666666666

test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_Test14_data27_sc_v2.csv')
