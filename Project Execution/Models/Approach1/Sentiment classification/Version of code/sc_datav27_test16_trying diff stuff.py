...
test1 = pd.read_csv('F:/somebody gonna get hurt/Github/Model/Test files for try17/test16.csv')
l =[]
...
#       [ 5, 20,  2],
#       [ 3,  1, 37]], dtype=int64)
accuracy= accuracy_score(test1['y'],y_pred) #0.8645833333333334

test1['y-pred']=y_pred
test1.to_csv('F:/somebody gonna get hurt/Github/Model/Results/Results_Test16_data27_sc_v4_0.75gamma.csv')
